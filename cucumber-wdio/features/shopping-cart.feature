...
Scenario: Clicking on increacing count button
  Given that I can see the product list
  When I scroll down to get the "Bread - French Baquette"
  # Then add the count to 3 of "Bread - French Baquette" should be added to the count button
  # When I click on the buy button for "Juice - Orange, Concentrate"
  # Then 3 item of "Bread - French Baquette" added to the menu of the shopping cart